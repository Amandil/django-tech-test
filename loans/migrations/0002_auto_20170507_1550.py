# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-05-07 15:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=0, default=Decimal('0.0'), default_currency='GBP', max_digits=6)),
                ('loan_deadline', models.DateField(default=datetime.date.today)),
        ...
        migrations.AlterField(
            model_name='business',
            name='crn',
            field=models.CharField(max_length=8, primary_key=True, serialize=False, unique=True, validators=[django.core.validators.MinLengthValidator(8)]),
        ),
        migrations.AddField(
            model_name='loan',
            name='target_business',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='loans.Business'),
        ),
    ]
